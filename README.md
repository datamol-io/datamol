...
_Note: The below contains the versions tested in the datamol CI. Lower Python versions while not tested will still likely works._

| `datamol` | `python`      | `rdkit`              |
| --------- | ------------- | -------------------- |
| `0.5`     | `[3.9, 3.10]` | `[2021.03, 2021.09]` |
