...
n_of_matches = [3,1,0]
l_of_props = [['PAINS_A', 'Brenk', 'Brenk'],
                ['Brenk'],
                []]
l_of_descriptions = [['hzone_phenol_A(479)', 'imine_1', 'Oxygen-nitrogen_single_bond'],
                        ['phenol_ester'],
                        []]
l_of_prop_lists = [[['description', 'FilterSet', 'Reference', 'Scope'],
...
def test_set_filter_params():
    ...
    Catalog = dm.filter.matches.set_filter_params(['PAINS_A','PAINS_A',
                                                   'PAINS_B','PAINS_C'])
    assert Catalog.GetNumEntries() == PAINS
