...
* Add `dm.get_conformer()` to retrieve the atomic positions of a conformer of a molecule.
* Add `dm.add_conformer()` to add a new confomer to a molecule given a list of atomic positions.
